...
// Fetch ALL requests (accepted and rejected) for this owner
$requests = [];
if (!empty($ownerEmail)) {
    $query = "SELECT 
                id,
...
<head>
    ...
    <link rel="stylesheet" href="./onwer_css/history.css">
    <title>History</title>
</head>
<body>
<div class="content-wrapper">
    ...
    <p class="page-subtitle">View all accepted and rejected requests</p>
                ...
                <?php } else { ?>
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 40px; color: #7f8c8d;">
                            ...
                            <h3 style="margin: 0 0 10px 0; color: #2c3e50;">No History Yet</h3>
                            <p style="margin: 0;">Accepted and rejected requests will appear here.</p>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
