...
<link rel="stylesheet" href="./onwer_css/onwer_registration.css">
<title>PG Reliable - Owner Registration</title>
<style>
  .email-feedback { font-size: 0.9em; margin-top: 5px; }
  .email-feedback.error { color: red; }
  .email-feedback.success { color: green; }
</style>
</head>
<body>
...
<div class="registration-container">
  ...
  <form action="./onwer_query.php" id="registrationForm" method="POST">
    ...
    <div class="form-group">
      ...
      <textarea name="address" required placeholder="Enter complete property address..."></textarea>
    </div>

    <div class="button-group">
      <button type="button" id="cancelBtn" class="btn btn-secondary">Cancel</button>
      <button type="submit" id="registerBtn" name="register" class="btn btn-primary">Create Account</button>
    </div>
  </form>
...
<script>
  ...
  emailField.addEventListener("blur", async () => {
      ...
      try {
          const res = await fetch("./onwer_query.php", {
              method: "POST",
              body: formData
          });
